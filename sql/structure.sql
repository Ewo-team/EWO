...
--
-- Client: localhost
-- Généré le: Mer 05 Septembre 2012 à 17:27
...
CREATE TABLE IF NOT EXISTS `at_log` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='table générique de log';
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='Destinataires des BAL';
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='Corps des BAL';
...
CREATE TABLE IF NOT EXISTS `morgue` (
  ...
  `nom_race_perso` varchar(100) NULL DEFAULT NULL,
  ...
  `nom_race_victime` varchar(100) NULL DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `persos` (
  ...
  `classe` tinyint(3) unsigned NULL DEFAULT NULL COMMENT '10ène = Ordre, unité = Caveau',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='Possession d''un familier';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='records realise par les joueurs d ewo';
...
CREATE TABLE IF NOT EXISTS `utilisateurs` (
  ...
  `jabberid` tinytext COLLATE utf8_unicode_ci COMMENT 'L''adresse Jabber de l''utilisateur',
  ...
  `telephone` tinytext COLLATE utf8_unicode_ci NOT NULL COMMENT 'telephone portable de l''utilisateur',
  `sms` varchar(10) COLLATE utf8_unicode_ci NOT NULL COMMENT 'nmbre de sms restant dans le compte de l''utilisateur',
  `session_id` char(255) COLLATE utf8_unicode_ci NOT NULL COMMENT 'session_id unique pour la gestion des APIs',
  `ticket` varchar(32) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'Ticket de connection pour l''autologin',
  PRIMARY KEY (`id`),
...
--
-- Contraintes pour la table `damier_objet_simple`
--
ALTER TABLE `damier_objet_simple`
  ADD CONSTRAINT `damier_objet_simple_ibfk_1` FOREIGN KEY (`case_objet_simple_id`) REFERENCES `case_objet_simple` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `damier_objet_simple_ibfk_2` FOREIGN KEY (`carte_id`) REFERENCES `cartes` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Contraintes pour la table `damier_persos`
--
ALTER TABLE `damier_persos`
  ADD CONSTRAINT `damier_persos_ibfk_1` FOREIGN KEY (`carte_id`) REFERENCES `cartes` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `damier_persos_ibfk_2` FOREIGN KEY (`perso_id`) REFERENCES `persos` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Contraintes pour la table `damier_porte`
--
ALTER TABLE `damier_porte`
  ADD CONSTRAINT `damier_porte_ibfk_2` FOREIGN KEY (`carte_id`) REFERENCES `cartes` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `damier_porte_ibfk_4` FOREIGN KEY (`objet_lie`) REFERENCES `damier_objet_complexe` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `damier_porte_ibfk_6` FOREIGN KEY (`porte_liee_id`) REFERENCES `damier_porte` (`id`) ON DELETE SET NULL ON UPDATE CASCADE,
  ADD CONSTRAINT `damier_porte_ibfk_7` FOREIGN KEY (`spawn_id`) REFERENCES `damier_spawn` (`id`) ON UPDATE CASCADE;
...
--
-- Contraintes pour la table `faction_grades`
--
ALTER TABLE `faction_grades`
  ADD CONSTRAINT `faction_grades_ibfk_1` FOREIGN KEY (`faction_id`) REFERENCES `factions` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Contraintes pour la table `faction_membres`
--
ALTER TABLE `faction_membres`
  ADD CONSTRAINT `faction_membres_ibfk_1` FOREIGN KEY (`perso_id`) REFERENCES `persos` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `faction_membres_ibfk_2` FOREIGN KEY (`faction_id`) REFERENCES `factions` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
--
-- Contraintes pour la table `utilisateurs_option`
--
ALTER TABLE `utilisateurs_option`
  ADD CONSTRAINT `utilisateurs_option_ibfk_1` FOREIGN KEY (`utilisateur_id`) REFERENCES `utilisateurs` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
