...
$target     = "./../../images/galons/".$grade."/";  // Répertoire cible
...
$prefix     = "galons/".$grade."/";  // Chemin du dépôt en fonction de la race.
...
echo "erreur d'ecriture du dossier";exit;
};*/
@mkDir($target);
            ...
            if(move_uploaded_file($_FILES['fichier']['tmp_name'],$target.$_FILES['fichier']['name'])) {
              // Si upload OK
  						...
  						//-- Mise à jour de la base avec le lien de l'avatar
							$sql = mysql_query("INSERT INTO icone_galons (id, grade_id, icone_url) VALUES ('','".$_POST['grade']."', '$cible')");
