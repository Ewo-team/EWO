...
// Si la variable  $_SESSION['temp']['erreurs'] est d�finie, alors stocke sa valeur dans la variable $msg_error .
	...
	<tr>
		<td>
			<table width="100%">
				...
				// Affichage des camps de la base de donn�es
				...
				<?php
				// Affichage de la partie permettant l'�dition au cas o� c'est demand�.
				...
				<tr>
					<td colspan="4">
						...
						<table width="100%">
							...
							<tr>
								<td align="left">Type de jeu (3 gros perso, 7 petites cr�as ou 0 pour parias) : </td>
								<td align="right">
							...
							<tr>
								...
								<td align="right">
									<select name="id_camp">
									<?php
									// Affichage des diff�rents choix pour les camps
									$liste_camps = mysql_query("SELECT id,nom FROM camps");
									
									// R�cup�ration des camps d�j� enregistr�s dans la base de donn�es.
