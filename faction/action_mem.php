...
$droits = b"$droits";
$virer_chef = Controle_other_membre('0',$perso_id, $faction_id);
$virer_bras = Controle_other_membre('1',$perso_id, $faction_id);
$virer_mem  = Controle_other_membre('2',$perso_id, $faction_id);
$droits_del = $virer_chef.$virer_bras.$virer_mem;
$droits_del = b"$droits_del";
...
{
$requete = "SELECT utilisateur_id, id, faction_id FROM persos WHERE (id REGEXP '$perso_id' OR nom REGEXP '$perso_id')";
$reponse = mysql_query ($requete) or die (mysql_error());
