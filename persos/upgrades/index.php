...
?>
		<form method="post">
			<select name="race">
				<option value="1"
				<?php echo ($race==1)? "selected='selected'" : "" ; ?>>Humain</option>
				<option value="2"
				<?php echo ($race==2)? "selected='selected'" : "" ; ?>>Paria</option>
				<option value="3"
				<?php echo ($race==3)? "selected='selected'" : "" ; ?>>Ange</option>
				<option value="4"
				<?php echo ($race==4)? "selected='selected'" : "" ; ?>>Demon</option>
			</select> <select name="grade">
				<option value="0"
				<?php echo ($grade==0)? "selected='selected'" : "" ; ?>>Grade 0</option>
				<option value="3"
				<?php echo ($grade==3)? "selected='selected'" : "" ; ?>>Grade 3</option>
				<option value="4"
				<?php echo ($grade==4)? "selected='selected'" : "" ; ?>>Grade 4</option>
				<option value="5"
				<?php echo ($grade==5)? "selected='selected'" : "" ; ?>>Grade 5</option>
			</select> <select name="galon">
				<option value="0"
				<?php echo ($galon==0)? "selected='selected'" : "" ; ?>>Galon 0</option>
				<option value="1"
				<?php echo ($galon==1)? "selected='selected'" : "" ; ?>>Galon 1</option>
				<option value="2"
				<?php echo ($galon==2)? "selected='selected'" : "" ; ?>>Galon 2</option>
				<option value="3"
				<?php echo ($galon==3)? "selected='selected'" : "" ; ?>>Galon 3</option>
				<option value="4"
				<?php echo ($galon==4)? "selected='selected'" : "" ; ?>>Galon 4</option>
			</select> <input type="submit" name="Choix"
				value="Choisir race, grade et galon" />
		</form>
		<?php
} else {
	echo "[<a href='".SERVER_URL."/jeu/index.php?perso_id=$id'>Retour</a>]<br />";
}
?>
		<table
			style="width: 95%; margin: auto; border: 1px solid #dad7b6; border-collapse: collapse;">
			<tr style="border-bottom: 1px solid #dad7b6;">
				<td class="jeu_upgrades" colspan="5"
					style="padding: 15px; text-align: center;"><?php if(!isset($admin_mode)) { ?>
					<span style="font-weight: bold;"><?php echo $_SESSION['persos']['nom'][$id];?>
				</span> dispose actuellement de <span id="nbrPi"><?php echo $pi;?> </span>
					<acronym title="Point d'Investissement">PI</acronym> <?php } else { ?>
					<span style="font-weight: bold;"> Co&ucirc;t total : <span
						id="nbrPi">0</span> <acronym title="Point d'Investissement">PI</acronym>
						<?php } ?>
			...
			<tr>
				...
				<td class="jeu_upgrades"><span id="valPvAff"><?php echo carac_max($race, $grade, 'pv', $donnees['niv_pv'], $perso_id, $galon); ?>
				</span></td>
				<td class="jeu_upgrades"><span id="coutPvAff"><?php echo $coutPv; ?>
				</span></td>
				<td class="jeu_upgrades"><input type="button" value="+"
					onclick="upCar(0);" />
				</td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td class="jeu_upgrades"><span id="valMouvAff"><?php echo carac_max($race, $grade, 'mouv', $donnees['niv_mouv'], $perso_id, $galon); ?>
				</span></td>
				<td class="jeu_upgrades"><span id="coutMouvAff"><?php echo $coutMouv; ?>
				</span></td>
				<td class="jeu_upgrades"><input type="button" value="+"
					onclick="upCar(2);" />
				</td>
			...
			<tr>
				<td class="jeu_upgrades">PA <a href="#infoPa">*</a>
				</td>
				<td class="jeu_upgrades"><?php echo $caracs['pa']+($bonus['pa']/10); ?>
				</td>
				<td class="jeu_upgrades"><span id="valPaAff"><?php echo (carac_max($race, $grade, 'pa', $donnees['niv_pa'], $perso_id, $galon) + carac_max($race, $grade, 'pa_dec', $donnees['niv_pa'], $perso_id, $galon) / 10); ?>
				</span></td>
				<td class="jeu_upgrades"><span id="coutPaAff"><?php echo $coutPa; ?>
				</span></td>
				<td class="jeu_upgrades"><input type="button" value="+"
					onclick="upCar(3);" />
				</td>
			...
			<tr>
				...
				<td class="jeu_upgrades"><?php echo $caracs['des']+$bonus['des']; ?>
				</td>
				<td class="jeu_upgrades"><span id="valdesAff"><?php echo carac_max($race, $grade, 'des', $donnees['niv_des'], $perso_id, $galon); ?>
				</span></td>
				<td class="jeu_upgrades"><span id="coutdesAff"><?php echo $coutDes; ?>
				</span></td>
				<td class="jeu_upgrades"><input type="button" value="+"
					onclick="upCar(4);" />
				</td>
			...
			<tr>
				...
				<td class="jeu_upgrades"><?php echo $caracs['force']+$bonus['force']; ?>
				</td>
				<td class="jeu_upgrades"><span id="valForceAff"><?php echo carac_max($race, $grade, 'force', $donnees['niv_force'], $perso_id, $galon); ?>
				</span></td>
				<td class="jeu_upgrades"><span id="coutForceAff"><?php echo $coutForce; ?>
				</span></td>
				<td class="jeu_upgrades"><input type="button" value="+"
					onclick="upCar(5);" />
				</td>
			...
			<tr>
				...
				<td class="jeu_upgrades"><span id="valPercAff"><?php echo carac_max($race, $grade, 'perception', $donnees['niv_perception'], $perso_id, $galon); ?>
				</span></td>
				<td class="jeu_upgrades"><span id="coutPercAff"><?php echo $coutPerc; ?>
				</span></td>
				<td class="jeu_upgrades"><input type="button" value="+"
					onclick="upCar(6);" />
				</td>
		...
		if(!isset($admin_mode) && ($affilie || $race == 1 || $race == 2 || $race == 3 || $race == 4
...
switch($donnees['cercle']){
	...
	case 10 :
		...
		<option value="5">Cercle de l\'Effroi</option>'.$select_end;
				}
		...
		<form method="post" action="upgradesencours.php" name="formUp">
			<input type="hidden" name="pvUp" value="0" /> <input type="hidden"
				name="recupPvUp" value="0" /> <input type="hidden" name="paUp"
				value="0" /> <input type="hidden" name="mouvUp" value="0" /> <input
				type="hidden" name="desUp" value="0" /> <input type="hidden"
				name="forceUp" value="0" /> <input type="hidden" name="percUp"
				value="0" /> <input type="hidden" name="nvMagUp" value="0" /> <input
				type="hidden" name="perso_id" value="<?php echo $perso_id ;?>" />
		</form>
...
//-->
		...
		<table id="caracs" style="display: none;">
			...
			<tbody>
				<?php if($donnees['niv_pv'] != 0) {
					...
					?>
				<tr>
					<th scope="row">PV - <?php echo $xpTotalPv; ?>xp
					</th>
			...
			?>
				<tr>
					<th scope="row">Récup. - <?php echo $xpTotalRecup; ?>xp
					</th>
			...
			?>
				<tr>
					<th scope="row">Mouvements - <?php echo $xpTotalMouv; ?>xp
					</th>
			...
			?>
				<tr>
					<th scope="row">PA - <?php echo $xpTotalPa; ?>xp
					</th>
			...
			?>
				<tr>
					<th scope="row">Dés - <?php echo $xpTotalDes; ?>xp
					</th>
			...
			?>
				<tr>
					<th scope="row">Force - <?php echo $xpTotalForce; ?>xp
					</th>
			...
			?>
				<tr>
					<th scope="row">Perception - <?php echo $xpTotalPercept; ?>xp
					</th>
			...
			?>
				<tr>
					<th scope="row">Magie - <?php echo $xpTotalMagie; ?>xp
					</th>
		...
		<div class="centrage">
			[<a
				href='<?php echo SERVER_URL; ?>/jeu/index.php?perso_id=<?php echo $id;?>'>Retour</a>]<br />
			<br /> <br />
